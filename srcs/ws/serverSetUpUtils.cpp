...
/*   Updated: 2025/07/03 17:20:10 by lbenatar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void cleanDoneClient(std::map<int, t_client> &clients, t_globalData &dataStruct)
{
	...
	while(it != clients.end())
	{
        ...
        {
            if (it->second.request.getUri() == "/Round_process?" || it->second.request.getUri() == "/Round_process")
            {
                dataStruct.data->VoixRobot1->announce(dataStruct.data->text_robot);
                std::cout << "\n\n\nROBOT TEXT : \n\n" << dataStruct.data->text_robot;
                std::cout << "\nFIN ROBOT TEXT\n\n\n";
                dataStruct.data->text_robot = "";
            }
