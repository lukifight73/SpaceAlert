...
void zone::setz_text_robot(std::string *str)
{
	z_text_robot = str;
}
void zone::setz_text_html(std::string *str)
{
	z_text_html = str;
}

void zone::addz_text_robot(std::string str)
{
	*z_text_robot += str;
}
void zone::addz_text_html(std::string str)
{
	*z_text_html += str;
}

std::string zone::getz_text_robot()
{
	return (*z_text_robot);
}

std::string zone::getz_text_html()
{
	return (*z_text_html);
}
