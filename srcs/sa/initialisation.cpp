...
void init_zone_white(t_data& data)
{
    ...
    data.zones[ZONE_WHITE]->setz_text_html(&data.text_html);
    data.zones[ZONE_WHITE]->setz_text_robot(&data.text_robot);
...
void init_zone_blue(t_data& data)
{
    ...
    data.zones[ZONE_BLUE]->setz_text_html(&data.text_html);
    data.zones[ZONE_BLUE]->setz_text_robot(&data.text_robot);
...
void init_zone_red(t_data& data)
{
    ...
    data.zones[ZONE_RED]->setz_text_html(&data.text_html);
    data.zones[ZONE_RED]->setz_text_robot(&data.text_robot);
