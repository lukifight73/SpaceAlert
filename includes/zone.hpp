...
class zone
{
    private:
        ...
        std::string *z_text_robot;
        std::string *z_text_html;
    ...
    public:
        ...
        //setters
        void setz_text_robot(std::string *str);
        void setz_text_html(std::string *str);
        ...
        //getters
        std::string getz_text_robot();
        std::string getz_text_html();
        ...
        void printZone();
        void addtemps();
        void addz_text_robot(std::string str);
        void addz_text_html(std::string str);
